...
---@param TitleText, MaxText string
---@return table
---@public
function NativeUI.CreatePercentagePanel(MinText, TitleText, MaxText)
    return UIMenuPercentagePanel.New(MinText, TitleText, MaxText)
end
...
function UIMenuColourPanel:UpdateSelection(PreventUpdate)
    ...
    self.Text:Text(self.Data.Title .. " (" .. CurrentSelection .. " sur " .. #self.Data.Items .. ")")
end
...
function UIMenuColourPanel:Functions()
    ...
    --@Key Process
    if IsDisabledControlJustPressed(0, 24) or IsDisabledControlJustPressed(0, 11) then
        self:GoLeft()
    end
    if IsDisabledControlJustPressed(0, 24) or IsDisabledControlJustPressed(0, 10) then
        self:GoRight()
    end
...
---@param TitleText, MaxText number
---@return table
---@public
function UIMenuPercentagePanel.New(MinText, TitleText, MaxText)
    local _UIMenuPercentagePanel = {
        ...
        Text = {
            ...
            Max = UIResText.New(MaxText or "100%", 0, 0, 0.35, 255, 255, 255, 255, 0, "Centre"),
            Title = UIResText.New(TitleText or "Opacity", 0, 0, 0.35, 255, 255, 255, 255, 0, "Centre"),
        },
        Audio = { Slider = "CONTINUOUS_SLIDER", Library = "HUD_FRONTEND_DEFAULT_SOUNDSET", Id = nil },
        ParentItem = nil,
    }
...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName, Heading, R, G, B, A)
    ...
    local _UIMenu = {
        ...
        Settings = {
            ...
            MouseControlsEnabled = true, -- aa
            MouseEdgeEnabled = false,
            ControlDisablingEnabled = true, -- aa
            DrawOrder = nil,
            Audio = {
...
function UIMenu:SelectItem()
    ...
    elseif subtype == "UIMenuSliderHeritageItem" then
        ...
        if Item.RightBadge.Badge ~= 21 then
            PlaySoundFrontend(-1, self.Settings.Audio.Select, self.Settings.Audio.Library, true)
        else
