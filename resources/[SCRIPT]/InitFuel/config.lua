...
Config.Strings = {
	...
	CancelFuelingPump = "Appuyez sur ~g~ E ~w~ pour annuler le remplissage",
	CancelFuelingJerryCan = "Appuyez sur ~g~ E ~w~ pour annuler le remplissage",
	NotEnoughCash = "Pas assez d'argent",
	RefillJerryCan = "Appuyez sur ~g~ E ~w~ pour remplir le jerrycan ",
	NotEnoughCashJerryCan = "Pas assez d'argent pour recharger le jerrycan",
	JerryCanFull = "Le jerry can est remplis",
	TotalCost = "Cout",
}
