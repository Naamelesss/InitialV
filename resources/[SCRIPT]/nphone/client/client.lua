...
RegisterNetEvent('InitialCore:OpenPhone')
AddEventHandler('InitialCore:OpenPhone', function(num)
  TooglePhone(num)
  TriggerEvent('gcPhone:myPhoneNumber', num)
end)
...
AddEventHandler("gcPhone:myPhoneNumber", function(_myPhoneNumber)
 ...
 -- TriggerServerEvent('InitialCore:SetNumber', myPhoneNumber)
...
function setReadMessageNumber(num, mynum)
  TriggerServerEvent('gcPhone:setReadMessageNumber', num, mynum)
  for k, v in ipairs(messages) do 
...
RegisterNetEvent('NPhone:MessageEntreprise')
AddEventHandler('NPhone:MessageEntreprise', function(data)
    print(data.number)
end)
...
RegisterNUICallback('sendMessage', function(data, cb)
  ...
  TriggerServerEvent('gcPhone:sendMessage', myPhoneNumber, data.phoneNumber, data.message)
end)
...
RegisterNUICallback('setReadMessageNumber', function (data, cb)
  setReadMessageNumber(data.number, myPhoneNumber)
  cb()
end)
--====================================================================================
--  Event - Contacts
...
RegisterNUICallback('addContact', function(data, cb) 
  TriggerServerEvent('gcPhone:addContact', data.display, data.phoneNumber, myPhoneNumber)
end)
...
function TooglePhone(num) 
  menuIsOpen = not menuIsOpen
  SendNUIMessage({show = menuIsOpen})
  if menuIsOpen == true then 
    TriggerServerEvent('NPhone:Refresh', num)
    PhonePlayIn()
  else
    PhonePlayOut()
  end
